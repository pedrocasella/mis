const photos = [
  ...
  'IMG_5890.JPG'
    ...
    photos.forEach((url)=>{ 
        document.getElementById('photo-ul').innerHTML += '<li><img data-src="./photos/' + url + '" alt="" class="photo" id="picture-' + url + '"></li>'
    })
...
//Expandir foto
  document.getElementById('photo-ul').addEventListener('click', (e)=>{
    if(e.target.id.indexOf('picture-') == -1){
        ...
        document.getElementById('openned-photo').src = './photos/' + e.target.id.replace('picture-', '')
