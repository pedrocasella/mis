...
if(prefersColorScheme.matches){
    ...
    document.querySelector('.nav-wave').innerHTML = '<path fill="#000" fill-opacity="1" d="M0,128L80,160C160,192,320,256,480,240C640,224,800,128,960,101.3C1120,75,1280,117,1360,138.7L1440,160L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>'
    document.querySelector('.insc-wave').innerHTML = '<path fill="#000" fill-opacity="1" d="M0,128L80,160C160,192,320,256,480,240C640,224,800,128,960,101.3C1120,75,1280,117,1360,138.7L1440,160L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>'
    document.querySelector('.comite_card').style.backgroundColor = '#000'
    document.getElementById('title').style.color = '#fff'
    document.querySelector('.modal_about').style.backgroundColor = '#000'
    ...
    document.querySelector('.imprensa').style.backgroundColor = '#000'
    ...
    document.querySelector('.inscricoes').style.backgroundColor = '#000'
    document.querySelector('.text_aic').style.backgroundColor = '#000'
    document.querySelector('.picture_aic').style.backgroundColor = '#000'
    document.querySelector('.background_aic').style.backgroundColor = '#000'
